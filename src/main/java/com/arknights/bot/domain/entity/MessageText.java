...
import com.arknights.bot.infra.util.FormatStringUtil;
...
public class MessageText {
    @ApiModelProperty(value = "字符串原文")
    private String s;
    @ApiModelProperty(value = "按行切分后数组")
    private String[] text;
    @ApiModelProperty(value = "最长的一行字符串")
    private String maxRow;
    @ApiModelProperty(value = "字符行数")
    private int rowsNum;

    public MessageText(String s) throws Exception {
        this.s = s;
